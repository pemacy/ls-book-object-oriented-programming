...
# Write an if/else statement that executes some code if
# the process_the_loop variable is true and some other code
# when process_the_loop is false. Specifically:

# When process_the_loop is true, execute a loop that iterates
# exactly once and prints The loop was processed during that iteration.
